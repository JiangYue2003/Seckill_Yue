...
type UserServiceClient interface {
	...
	// 更新用户信息
	UpdateUserInfo(ctx context.Context, in *UpdateUserInfoRequest, opts ...grpc.CallOption) (*common.BoolResponse, error)
	// 修改密码
	ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*common.BoolResponse, error)
}
...
func (c *userServiceClient) UpdateUserInfo(ctx context.Context, in *UpdateUserInfoRequest, opts ...grpc.CallOption) (*common.BoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userServiceClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*common.BoolResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(common.BoolResponse)
...
type UserServiceServer interface {
	...
	// 更新用户信息
	UpdateUserInfo(context.Context, *UpdateUserInfoRequest) (*common.BoolResponse, error)
	// 修改密码
	ChangePassword(context.Context, *ChangePasswordRequest) (*common.BoolResponse, error)
...
func (UnimplementedUserServiceServer) Register(context.Context, *RegisterRequest) (*UserInfo, error) {
...
func (UnimplementedUserServiceServer) UpdateUserInfo(context.Context, *UpdateUserInfoRequest) (*common.BoolResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateUserInfo not implemented")
}
func (UnimplementedUserServiceServer) ChangePassword(context.Context, *ChangePasswordRequest) (*common.BoolResponse, error) {
