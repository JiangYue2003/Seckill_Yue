...
const file_proto_order_proto_rawDesc = "" +
	...
	"\x12ORDER_TYPE_SECKILL\x10\x012\x95\x03\n" +
	"\fOrderService\x12F\n" +
...
var file_proto_order_proto_goTypes = []any{
	...
	(*RefundOrderRequest)(nil),       // 10: order.RefundOrderRequest
	(*common.BoolResponse)(nil),      // 11: common.BoolResponse
}
var file_proto_order_proto_depIdxs = []int32{
	3,  // 0: order.ListUserOrdersResponse.orders:type_name -> order.OrderInfo
	4,  // 1: order.OrderService.CreateNormalOrder:input_type -> order.CreateNormalOrderRequest
	5,  // 2: order.OrderService.GetOrder:input_type -> order.GetOrderRequest
	6,  // 3: order.OrderService.ListUserOrders:input_type -> order.ListUserOrdersRequest
	8,  // 4: order.OrderService.CancelOrder:input_type -> order.CancelOrderRequest
	9,  // 5: order.OrderService.PayOrder:input_type -> order.PayOrderRequest
	10, // 6: order.OrderService.RefundOrder:input_type -> order.RefundOrderRequest
	3,  // 7: order.OrderService.CreateNormalOrder:output_type -> order.OrderInfo
	3,  // 8: order.OrderService.GetOrder:output_type -> order.OrderInfo
	7,  // 9: order.OrderService.ListUserOrders:output_type -> order.ListUserOrdersResponse
	11, // 10: order.OrderService.CancelOrder:output_type -> common.BoolResponse
	11, // 11: order.OrderService.PayOrder:output_type -> common.BoolResponse
	11, // 12: order.OrderService.RefundOrder:output_type -> common.BoolResponse
