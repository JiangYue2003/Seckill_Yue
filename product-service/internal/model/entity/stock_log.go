...
type StockLog struct {
	...
	OrderID     string `gorm:"type:varchar(32);not null;uniqueIndex:uk_order_change_type,priority:1" json:"order_id"` // 订单号
	ChangeType  int    `gorm:"not null;uniqueIndex:uk_order_change_type,priority:2" json:"change_type"`               // 变更类型: 1=扣减, 2=回滚
