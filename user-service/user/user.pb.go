...
const file_user_proto_rawDesc = "" +
	...
	"\fnew_password\x18\x03 \x01(\tR\vnewPassword2\xb1\x02\n" +
	"\vUserService\x121\n" +
	...
	"\vGetUserInfo\x12\x18.user.GetUserInfoRequest\x1a\x0e.user.UserInfo\x12A\n" +
	"\x0eUpdateUserInfo\x12\x1b.user.UpdateUserInfoRequest\x1a\x12.user.BoolResponse\x12A\n" +
	"\x0eChangePassword\x12\x1b.user.ChangePasswordRequest\x1a\x12.user.BoolResponseB\bZ\x06./userb\x06proto3"
...
var file_user_proto_goTypes = []any{
	(*BoolResponse)(nil),          // 0: user.BoolResponse
...
var file_user_proto_depIdxs = []int32{
	...
	5, // 2: user.UserService.GetUserInfo:input_type -> user.GetUserInfoRequest
	6, // 3: user.UserService.UpdateUserInfo:input_type -> user.UpdateUserInfoRequest
	7, // 4: user.UserService.ChangePassword:input_type -> user.ChangePasswordRequest
	4, // 5: user.UserService.Register:output_type -> user.UserInfo
	3, // 6: user.UserService.Login:output_type -> user.LoginResponse
	4, // 7: user.UserService.GetUserInfo:output_type -> user.UserInfo
	0, // 8: user.UserService.UpdateUserInfo:output_type -> user.BoolResponse
	0, // 9: user.UserService.ChangePassword:output_type -> user.BoolResponse
