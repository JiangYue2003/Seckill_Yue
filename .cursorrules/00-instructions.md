...
4. [zero-skills](../.ai-context/zero-skills/SKILL.md) - Detailed patterns (查阅详细模式)
...
For complete implementation patterns, refer to [zero-skills](../.ai-context/zero-skills/SKILL.md):
